...
const FALLBACK_SLUGS = ["concerta-vs-vyvanse","vyvanse-vs-adderall","dextroamphetamine-vs-adderall","focalin-vs-vyvanse","amphetamine-salts-vs-dextroamphetamine"] as string[];
