...
export default function DistrictBehavioralHealth() {
  return (
    <Layout5>
      <div id="content" className="site-main post-1034 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
        ...
        <section id="comments" className="comments-area">
          <div id="respond" className="comment-respond">
            <h2 id="reply-title" className="comment-reply-title">
              Leave a Reply
              <small>
                <Link href="/10-essential-steps-to-achieving-lasting-addiction-recovery-3/#respond" rel="nofollow" id="cancel-comment-reply-link">Cancel reply</Link>
              </small>
            </h2>
