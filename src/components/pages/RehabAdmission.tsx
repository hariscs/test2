              ...
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-f509614 elementor-widget-mobile__width-auto elementor-absolute elementor-widget elementor-widget-image">
                  <div className="elementor-widget-container">
                    <img fetchPriority="high" src="/images/8b15cf55269d803754c7ea1986b1a7bc.webp" alt="banner left iconpng" className="attachment-full size-full wp-image-103266" style={{maxWidth: "100%", height: "auto"}} />
                  </div>
                </div>
