...
export default function CroVariation2(props: Record<string, string>) {
  const h1 = props.h1 ?? "ALCOHOL ADDICTION REHAB TREATMENT AT GRATITUDE LODGE";
  const phone = props.phone ?? "Call Now! 844-917-4100";
  ...
  return (
    <>
    <div className="wp-singular page-template-default page page-id-1084 wp-custom-logo wp-theme-hello-elementor elementor-default elementor-template-full-width elementor-kit-7 elementor-page-978 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit">
  <div className="elementor elementor-978 elementor-location-single post-1084 page type-page status-publish hentry template-cro2-national-rehab template-national-rehab">
    <div className="elementor-element elementor-element-225b161 e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-f3c2ad5 elementor-widget-mobile__width-auto elementor-absolute elementor-widget elementor-widget-image">
          <div className="elementor-widget-container">
            <link rel="preload" as="image" href="/images/ee5aa84dbcc3afd918acc8efb5cf1566.webp" fetchPriority="high" /><img fetchPriority="high" src="/images/ee5aa84dbcc3afd918acc8efb5cf1566.webp" alt="" width={461} height={537} className="attachment-full size-full wp-image-991" />
          </div>
        </div>
        <div className="elementor-element elementor-element-6c0fdf7 e-flex e-con-boxed e-con e-child">
          <div className="e-con-inner">
            <div className="elementor-element elementor-element-041a013 e-con-full elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child">
              <div className="elementor-element elementor-element-a1cdcb9 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
              ...
              <div className="elementor-element elementor-element-41df65c elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <div className="elementor-heading-title elementor-size-default">
            ...
            <div className="elementor-element elementor-element-f75ffe2 e-flex e-con-boxed e-con e-child">
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-9fbf845 elementor-widget elementor-widget-heading">
                  <div className="elementor-widget-container">
                ...
                <div className="elementor-element elementor-element-0f66d0c e-con-full e-flex e-con e-child">
                  <div className="elementor-element elementor-element-b705204 elementor-widget elementor-widget-image">
                    <div className="elementor-widget-container">
                  ...
                  <div className="elementor-element elementor-element-4a5fcde elementor-widget elementor-widget-image">
                    <div className="elementor-widget-container">
                  ...
                  <div className="elementor-element elementor-element-c869726 elementor-widget elementor-widget-image">
                    <div className="elementor-widget-container">
            ...
            <div className="elementor-element elementor-element-b6acd52 e-con-full e-flex e-con e-child">
              <div className="elementor-element elementor-element-8faf83d elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-initial elementor-widget-mobile__width-auto author-box-sty elementor-author-box--layout-image-left elementor-widget elementor-widget-author-box">
                <div className="elementor-widget-container">
                  <div className="elementor-author-box">
                    <div className="elementor-author-box__avatar">
                      <img loading="lazy" src="/images/78768a6fbd4e3e5d0918efa1fe055fd5.webp" alt="Picture of Written By:" width={300} height={300} />
                    </div>
              ...
              <div className="elementor-element elementor-element-0b108e6 elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-initial elementor-widget-mobile__width-auto author-box-sty elementor-author-box--layout-image-left elementor-widget elementor-widget-author-box">
                <div className="elementor-widget-container">
                  <div className="elementor-author-box">
                    <div className="elementor-author-box__avatar">
              ...
              <div className="elementor-element elementor-element-004f310 elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-initial author-box-sty elementor-widget-mobile__width-auto elementor-author-box--layout-image-left elementor-widget elementor-widget-author-box">
                <div className="elementor-widget-container">
                  <div className="elementor-author-box">
                    <div className="elementor-author-box__avatar">
        ...
        <div className="elementor-element elementor-element-1b3db93 elementor-absolute elementor-widget elementor-widget-image">
          <div className="elementor-widget-container">
            <img loading="lazy" src="/images/b362d0cd244068c2f60724058d3431ff.webp" alt="" width={461} height={537} className="attachment-full size-full wp-image-988" />
          </div>
        </div>
      </div>
    </div>
    <div className="elementor-element elementor-element-6642eb82 e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-2967af80 e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-322f0de7 e-con-full e-flex e-con e-child">
            <div className="elementor-element elementor-element-3cf8c60b e-con-full e-flex e-con e-child">
              <div className="elementor-element elementor-element-49e64e6d elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
            ...
            <div className="elementor-element elementor-element-215f2cf7 e-con-full e-flex e-con e-child">
              <div className="elementor-element elementor-element-50063197 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                <div className="elementor-widget-container">
              ...
              <div className="elementor-element elementor-element-5fd9226b elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                <div className="elementor-widget-container">
                  <div className="elementor-button-wrapper">
    ...
    <div className="elementor-element elementor-element-c45d933 table-of-content-headings empty-container-sty e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-208370e elementor-widget__width-initial elementor-widget elementor-widget-text-editor">
          <div className="elementor-widget-container">
    ...
    <div className="elementor-element elementor-element-1c8d575 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-078cbbd elementor-widget elementor-widget-template">
        <div className="elementor-widget-container">
    ...
    <div className="elementor-element elementor-element-5364594 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-8e3f5ee elementor-widget elementor-widget-template">
        <div className="elementor-widget-container">
          <div className="elementor-template">
                ...
                <div className="e-con-inner">
                  ...
                  <div className="elementor-element elementor-element-4ea39b57 e-con-full e-flex e-con e-child">
                    ...
                    <div className="elementor-element elementor-element-493db9b9 elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-arrows-position-inside elementor-widget elementor-widget-loop-carousel e-widget-swiper">
                      <div className="elementor-widget-container">
                        <div className="swiper elementor-loop-container elementor-grid swiper-initialized swiper-horizontal swiper-pointer-events" role="list" dir="ltr">
                          <div className="swiper-wrapper" aria-live="off" id="swiper-wrapper-1673316d47ee9b02" style={{"transitionDuration":"0ms","transform":"none"}}>
					...
					Watching my loved one thrive after treatment at Alliance Recovery was life-changing. The team’s dedication to her healing was beyond anything I could have imagined.				
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-prev" role="button" tabIndex={0} aria-label="Previous slide" aria-controls="swiper-wrapper-1673316d47ee9b02">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-next" role="button" tabIndex={0} aria-label="Next slide" aria-controls="swiper-wrapper-1673316d47ee9b02">
    ...
    <div className="elementor-element elementor-element-f561f5e e-con-full e-flex e-con e-parent">
      <div className="elementor-element elementor-element-6751762 elementor-widget elementor-widget-template">
        <div className="elementor-widget-container">
          <div className="elementor-template">
                  ...
                  <div className="elementor-element elementor-element-793c79f8 e-con-full e-flex e-con e-child">
                    ...
                    <div className="elementor-element elementor-element-76f6ff2e e-con-full elementor-hidden-mobile e-flex e-con e-child">
                      <div className="elementor-element elementor-element-6dfc5e0d elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                            <Link className="elementor-button elementor-button-link elementor-size-sm" href="tel:+19497497960">
                              <span className="elementor-button-content-wrapper">
                                <span className="elementor-button-text">
                                  Tour Our Facilities
                                </span>
                  ...
                  <div className="elementor-element elementor-element-7379b0fa elementor-arrows-position-outside elementor-pagination-position-outside elementor-widget elementor-widget-image-carousel e-widget-swiper">
                    <div className="elementor-widget-container">
                      <div className="elementor-image-carousel-wrapper swiper swiper-initialized swiper-horizontal swiper-pointer-events" role="region" aria-roledescription="carousel" aria-label="Image Carousel" dir="ltr">
                        <div className="elementor-image-carousel swiper-wrapper swiper-image-stretch" aria-live="off" style={{"transform":"none","transitionDuration":"0ms"}} id="swiper-wrapper-54b4bdbdc1078bf38">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-prev" role="button" tabIndex={0} aria-label="Previous slide" aria-controls="swiper-wrapper-54b4bdbdc1078bf38">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-next" role="button" tabIndex={0} aria-label="Next slide" aria-controls="swiper-wrapper-54b4bdbdc1078bf38">
    ...
    <div className="elementor-element elementor-element-564347d e-con-full e-flex e-con e-parent">
      <div className="elementor-element elementor-element-34e3930 elementor-widget elementor-widget-template">
        <div className="elementor-widget-container">
          <div className="elementor-template">
    ...
    <div className="elementor-element elementor-element-a14c15f e-con-full e-flex e-con e-parent">
      <div className="elementor-element elementor-element-fab37ea elementor-widget elementor-widget-template">
        <div className="elementor-widget-container">
          <div className="elementor-template">
    ...
    <div className="elementor-element elementor-element-4ae2736 e-flex e-con-boxed e-con e-parent">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-e1f5ed5 elementor-widget elementor-widget-menu-anchor">
          <div className="elementor-widget-container">
            <div className="elementor-menu-anchor" id="verifyinsurance"></div>
          </div>
        </div>
        <div className="elementor-element elementor-element-728b275 e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-8d63416 e-con-full e-flex e-con e-child">
            <div className="elementor-element elementor-element-76a2cb1 e-con-full e-flex e-con e-child">
              <div className="elementor-element elementor-element-f48f941 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <h2 className="elementor-heading-title elementor-size-default">
                    Contact Us
                  </h2>
              ...
              <div className="elementor-element elementor-element-96f9142 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <h2 className="elementor-heading-title elementor-size-default">
              ...
              <div className="elementor-element elementor-element-44e4b04 elementor-widget elementor-widget-text-editor">
                <div className="elementor-widget-container">
                  <p>
            ...
            <div className="elementor-element elementor-element-b46b4ec elementor-widget elementor-widget-image">
              <div className="elementor-widget-container">
          ...
          <div className="elementor-element elementor-element-6279172 e-con-full e-flex e-con e-child">
            <div className="elementor-element elementor-element-f44d7c4 elementor-widget__width-inherit elementor-widget-mobile__width-inherit elementor-widget elementor-widget-html">
              <div className="elementor-widget-container">
