...
export default function DistrictBehavioralHealth() {
  return (
    <Layout4>
      <div id="content" className="site-main post-1031 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
        ...
        <section id="comments" className="comments-area">
          <div id="respond" className="comment-respond">
            <h2 id="reply-title" className="comment-reply-title">
              Leave a Reply
              <small>
                <Link href="/10-essential-steps-to-achieving-lasting-addiction-recovery-2/#respond" rel="nofollow" id="cancel-comment-reply-link">Cancel reply</Link>
              </small>
            </h2>
