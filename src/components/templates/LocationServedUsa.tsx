...
export default function LocationServedUsa(props: Record<string, string>) {
  ...
  const h2___head = props.h2___head ?? "Addiction Treatment Programs at District Behavioral Health";
  const h2___con = props.h2___con ?? "<p>Addiction can slowly pull you away from the life you were once part of. Work starts to feel harder. Focus fades. Even simple routines, As cravings take over, begin to slip. life that used to feel easy start to feel too much. And when nothing feels steady, reaching out for help can feel just as hard.</p>\r\n\r\n<p>Addiction treatment at a dedicated rehab gives you a steady way forward before everything falls apart. Care starts with clear support and a plan that meets you where you are today. With us, care begins with clear support and a plan that fits where you are today. Recovery starts to feel possible again, and we help you move forward with steady steps and the right support at every stage.</p>\r\n\r\n<ul>\r\n  <li>Addiction makes it harder to show up for yourself and others.</li>\r\n  <li>Cravings and stress slowly take control of your daily life.</li>\r\n  <li>Getting help can feel unclear or out of reach.</li>\r\n  <li>A dedicated rehab gives you a steady way forward.</li>\r\n  <li>Recovery feels possible when care meets you where you are.</li>\r\n</ul>\r\n\r\n<p>Renaissance Recovery provides addiction treatment through the District Behavioral Health network, offering care that is steady and shaped around your individual progress. Each care program is adapted to match your needs, with a focus on what works for your symptoms and daily challenges.</p>\r\n\r\n<p>Addiction treatment helps you begin with what you have and keep taking steps, even when life feels difficult. It gives you the support to stay grounded and show up for what matters.</p>\r\n\r\n<p>See more about our addiction treatment program below.</p>";
  return (
    <>
    <div className="wp-singular page-template-default page page-id-1751 page-child parent-pageid-1737 wp-custom-logo wp-theme-hello-elementor elementor-default elementor-template-full-width elementor-kit-7 elementor-page elementor-page-1751 elementor-page-691 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit">
  <div className="elementor elementor-691 elementor-location-single post-1751 page type-page status-publish hentry intent-high marketing-channel-seo template-cro1-national-rehab template-national-rehab topic-drug">
            ...
            <div className="elementor-element elementor-element-4e779022 e-con-full elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child">
              <div className="elementor-element elementor-element-4f8f4afc elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <div className="elementor-heading-title elementor-size-default">
                    <Link href="#">
                      Inpatient Alcohol {topic_2} Treatment
                    </Link>
                  </div>
                </div>
              </div>
              <div className="elementor-element elementor-element-7861a6e2 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <div className="elementor-heading-title elementor-size-default">
                    <Link href="#">
                      Outpatient Alcohol {topic_2} Treatment
                    </Link>
                  </div>
                </div>
              </div>
    ...
    <div className="elementor-element elementor-element-57830ff4 table-of-content-headings e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-5362f2f6 e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-28fe4158 table-of-content-sty elementor-toc--content-ellipsis elementor-widget elementor-widget-table-of-contents">
            <div className="elementor-widget-container">
                ...
                <ol className="elementor-toc__list-wrapper">
                  <li className="elementor-toc__list-item">
                    <div className="elementor-toc__list-item-text-wrapper">
                      <Link href="#elementor-toc__heading-anchor-0" className="elementor-toc__list-item-text elementor-toc__top-level elementor-item-active">
                        {h2___head}
                      </Link>
                    </div>
                  </li>
        ...
        <div className="elementor-element elementor-element-75f574f5 e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-309b4571 elementor-widget elementor-widget-heading">
            <div className="elementor-widget-container">
          ...
          <div className="elementor-element elementor-element-5e511adb elementor-widget elementor-widget-text-editor">
            <div className="elementor-widget-container">
    ...
    <div className="elementor-element elementor-element-49f1055 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-5207043 elementor-widget elementor-widget-shortcode">
        <div className="elementor-widget-container">
          <div className="elementor-shortcode">
            <div className="elementor elementor-1260">
              <div className="elementor-element elementor-element-25a89314 addiction-care-cta-v1-section e-flex e-con-boxed e-con e-parent e-lazyloaded">
                <div className="e-con-inner">
                  <div className="elementor-element elementor-element-763e7dcd e-con-full e-flex e-con e-child">
                    <div className="elementor-element elementor-element-5a6bc6f3 elementor-widget elementor-widget-heading">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                    ...
                    <div className="elementor-element elementor-element-27baceac elementor-widget elementor-widget-text-editor">
                      <div className="elementor-widget-container">
                        <p>
                    ...
                    <div className="elementor-element elementor-element-91916 elementor-widget-divider--view-line elementor-widget elementor-widget-divider">
                      <div className="elementor-widget-container">
                    ...
                    <div className="elementor-element elementor-element-082c92a e-con-full e-flex e-con e-child">
                      <div className="elementor-element elementor-element-cf07434 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                            <Link className="elementor-button elementor-button-link elementor-size-sm" href="tel:888-707-6073">
                              <span className="elementor-button-content-wrapper">
                      ...
                      <div className="elementor-element elementor-element-92e20aa elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                            <Link className="elementor-button elementor-button-link elementor-size-sm" href="#verifyinsurace">
                              <span className="elementor-button-content-wrapper">
                      ...
                      <div className="elementor-element elementor-element-cfde672 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                            <Link className="elementor-button elementor-button-link elementor-size-sm" href="#verifyinsurace">
                              <span className="elementor-button-content-wrapper">
    ...
    <div className="elementor-element elementor-element-5e096e30 empty-container-sty e-flex e-con-boxed e-con e-parent">
      <div className="e-con-inner"></div>
    </div>
    <div className="elementor-element elementor-element-d1f0d7b e-con-full e-flex e-con e-parent">
                ...
                <div className="e-con-inner">
                  ...
                  <div className="elementor-element elementor-element-4ea39b57 e-con-full e-flex e-con e-child">
                    ...
                    <div className="elementor-element elementor-element-493db9b9 elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-arrows-position-inside elementor-widget elementor-widget-loop-carousel e-widget-swiper">
                      <div className="elementor-widget-container">
                        <div className="swiper elementor-loop-container elementor-grid swiper-initialized swiper-horizontal swiper-pointer-events" role="list" dir="ltr">
                          <div className="swiper-wrapper" aria-live="off" id="swiper-wrapper-5e65bce21c3ad109" style={{"transitionDuration":"0ms","transform":"none"}}>
					...
					Watching my loved one thrive after treatment at Alliance Recovery was life-changing. The team’s dedication to her healing was beyond anything I could have imagined.				
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-prev" role="button" tabIndex={0} aria-label="Previous slide" aria-controls="swiper-wrapper-5e65bce21c3ad109">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-next" role="button" tabIndex={0} aria-label="Next slide" aria-controls="swiper-wrapper-5e65bce21c3ad109">
                  ...
                  <div className="elementor-element elementor-element-7379b0fa elementor-arrows-position-outside elementor-pagination-position-outside elementor-widget elementor-widget-image-carousel e-widget-swiper">
                    <div className="elementor-widget-container">
                      <div className="elementor-image-carousel-wrapper swiper swiper-initialized swiper-horizontal swiper-pointer-events" role="region" aria-roledescription="carousel" aria-label="Image Carousel" dir="ltr">
                        <div className="elementor-image-carousel swiper-wrapper swiper-image-stretch" aria-live="off" id="swiper-wrapper-f10dfd57c6349459c" style={{"transform":"none","transitionDuration":"0ms"}}>
                          <div className="swiper-slide swiper-slide-duplicate-next" role="group" aria-roledescription="slide" aria-label="1 / 6" style={{"width":"497.667px","marginRight":"20px","visibility":"visible"}}>
                          ...
                          <div className="swiper-slide swiper-slide-prev" role="group" aria-roledescription="slide" aria-label="5 / 6" style={{"width":"497.667px","marginRight":"20px","visibility":"visible"}}>
                          ...
                          <div className="swiper-slide swiper-slide-active" role="group" aria-roledescription="slide" aria-label="6 / 6" style={{"width":"497.667px","marginRight":"20px","visibility":"visible"}}>
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-prev" role="button" tabIndex={0} aria-label="Previous slide" aria-controls="swiper-wrapper-f10dfd57c6349459c">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-next" role="button" tabIndex={0} aria-label="Next slide" aria-controls="swiper-wrapper-f10dfd57c6349459c">
                ...
                <div className="cards" role="list">
                  ...
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/outpatient-drug-rehab/">
                      <h3>
                        Outpatient {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/iop-drug-rehab/">
                      <h3>
                        IOP {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/php-drug-rehab/">
                      <h3>
                        PHP {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                  ...
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/pet-friendly-rehab/">
                      <h3>
                        Pet Friendly {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                  ...
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/lgbtq-drug-rehab/">
                      <h3>
                        LGBTQ {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                  ...
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/location-served/usa/couples-rehab/">
                      <h3>
                        Couples {topic_2} Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
                  ...
                  <article className="card" role="listitem" style={{"display":"none"}}>
                    <Link href="/cro-variation-1/">
                      <h3>
                        ALCOHOL ADDICTION REHAB TREATMENT AT GRATITUDE LODGE
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"none"}}>
